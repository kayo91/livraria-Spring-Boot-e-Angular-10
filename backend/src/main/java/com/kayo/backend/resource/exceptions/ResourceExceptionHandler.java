package com.kayo.backend.resource.exceptions;
...
import com.kayo.backend.service.exceptions.ObjectNotFoundException;
...
//	pesquisar erro - get no  localhost:8080/categorias/4
}
